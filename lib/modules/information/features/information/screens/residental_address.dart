...
class ResidentialAddressWidget extends StatefulWidget {
  static const routeName = '/residentialAddress';

  @override
  _ResidentialAddressWidgetState createState() =>
      _ResidentialAddressWidgetState();
}

class _ResidentialAddressWidgetState extends State<ResidentialAddressWidget> {
  ...
  void _updatePatientInformation(PatientInformationModel patientInfo) {
    setState(() {
      ...
      _address1Controller.text = patientInfo.address1 ?? "";
      _address2Controller.text = patientInfo.address2 ?? "";
      _cityController.text = patientInfo.city ?? "";
      _stateSelectValue = patientInfo.state ?? "";
      _zipController.text = patientInfo.zipCode ?? "";
  ...
  void _onSavePressed() {
    setState(() {
      _patientInfo.address1 = _address1Controller.text;
      _patientInfo.address2 = _address2Controller.text;
      _patientInfo.city = _cityController.text;
      _patientInfo.zipCode = _zipController.text;

      _patientInfo.state = _stateSelectValue;
          ...
          Row(
            children: <Widget>[
              Container(
                ...
                child: SubMenu(4, 1, demographics: true),
              ),
              Container(
                    ...
                    builder: (context,
                      ...
                      return Form(
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            CommonText("Residential Address", false),
                            SizedBox(height: 12),
                            TextFormField(
                              style: _optionTextStyle,
